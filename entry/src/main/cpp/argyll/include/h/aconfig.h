 ...
 *
 * Copyright 2006 - 2026, Graeme W. Gill
 * All rights reserved.
 *
...
/* OHOS changes: HarmonyOS has no X11, so leave both UNIX_APPLE and */
/* UNIX_X11 undefined. The OHOS USB backend is selected by __OHOS__ */
/* in usbio.c / usbio.h. */
#  undef UNIX_APPLE
#  undef UNIX_X11
# else
