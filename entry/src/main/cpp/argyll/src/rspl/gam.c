...
/* OHOS changes: vrml.h is not part of the ported subset. */
/* #include "vrml.h" */
...
#if 0	/* OHOS changes: requires the vrml library - not part of the ported subset */
/* Diagnostic */
...
#endif	/* OHOS changes: end of vrml dependent rspl_gam_plot */
