...
#if defined(__OHOS__)
		/* OHOS changes: musl libc has no pthread_cancel() - mark the */
		/* thread as joined and leave it to exit on its own. */
		DBG("athread_terminate skipping pthread_cancel() (no musl equivalent)\n");
#else
