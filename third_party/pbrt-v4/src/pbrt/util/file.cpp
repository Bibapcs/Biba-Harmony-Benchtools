...
#include <dirent.h>
#include <fcntl.h>
// <sys/dir.h> is a legacy header that musl libc provides but bionic (Android)
// does not; dirent.h above already supplies everything needed here.
#if !defined(__has_include) || __has_include(<sys/dir.h>)
#include <sys/dir.h>
#endif
#include <sys/stat.h>
#include <sys/types.h>
